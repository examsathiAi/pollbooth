  ...
  return (
    <article className="border-b border-slate-100 bg-white p-4">
      <div className="mb-3 flex flex-wrap items-center gap-2">
        <span className="rounded-full bg-blue-50 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.2em] text-blue-600">
        ...
        <div className="space-y-2">
          {poll.options.map((option, idx) => (
            <button
              ...
              disabled={isVoting}
              className="w-full rounded-2xl border border-slate-200 px-4 py-3 text-left text-sm font-medium text-slate-700 transition-all duration-200 hover:border-blue-400 hover:bg-blue-50 active:scale-[0.99] disabled:opacity-60"
            >
              {option}
            </button>
          ))}
      ...
      <div className="mt-4 flex items-center justify-between gap-3 rounded-2xl border border-slate-100 bg-slate-50/70 px-3 py-2">
        <button onClick={handleShare} className="flex items-center gap-2 rounded-full px-2 py-1 text-sm font-medium text-slate-600 transition hover:bg-white hover:text-blue-600">
        ...
        <button onClick={() => setShowOpinions((value) => !value)} className="flex items-center gap-2 rounded-full px-2 py-1 text-sm font-medium text-slate-600 transition hover:bg-white hover:text-blue-600">
